...
func (c *CtlAgent) DropIPStats(ctx context.Context, in *pb.Stats) (*pb.StatsResult, error) {
	timedCtx, cancel := context.WithTimeout(ctx, time.Second)
	defer cancel()
	return c.client.DropIPStats(timedCtx, in)
}

func (c *CtlAgent) DropLoginStats(ctx context.Context, in *pb.Stats) (*pb.StatsResult, error) {
	timedCtx, cancel := context.WithTimeout(ctx, time.Second)
	defer cancel()
	return c.client.DropLoginStats(timedCtx, in)
}

func (c *CtlAgent) DropPasswordStats(ctx context.Context, in *pb.Stats) (*pb.StatsResult, error) {
	timedCtx, cancel := context.WithTimeout(ctx, time.Second)
	defer cancel()
	return c.client.DropPasswordStats(timedCtx, in)
}

func (c *CtlAgent) AddBlacklist(ctx context.Context, in *pb.Subnet) (*pb.SubnetResult, error) {
	timedCtx, cancel := context.WithTimeout(ctx, time.Second)
	defer cancel()
	return c.client.AddBlacklist(timedCtx, in)
}

func (c *CtlAgent) RemoveBlacklist(ctx context.Context, in *pb.Subnet) (*pb.SubnetResult, error) {
	timedCtx, cancel := context.WithTimeout(ctx, time.Second)
	defer cancel()
	return c.client.RemoveBlacklist(timedCtx, in)
}

func (c *CtlAgent) AddWhitelist(ctx context.Context, in *pb.Subnet) (*pb.SubnetResult, error) {
	timedCtx, cancel := context.WithTimeout(ctx, time.Second)
	defer cancel()
	return c.client.AddWhitelist(timedCtx, in)
}

func (c *CtlAgent) RemoveWhitelist(ctx context.Context, in *pb.Subnet) (*pb.SubnetResult, error) {
	timedCtx, cancel := context.WithTimeout(ctx, time.Second)
	defer cancel()
